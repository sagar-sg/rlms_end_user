...
import com.rlms.R;
import com.rlms.fragments.AddNewComplaintFragment;
import com.rlms.fragments.ComplainHomeFragment;

public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    AddNewComplaintFragment addNewComplaintFragment = new AddNewComplaintFragment();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setCheckedItem(R.id.nav_add_complaints);
        loadAddComplaintsFragment();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_add_complaints) {
...
//            }
   ...
   /* public void loadAddComplaintsFragment() {

        FragmentTransaction fragmentTransaction = fragmentManager
                .beginTransaction();

        if (!addNewComplaintFragment.isAdded() && !addNewComplaintFragment.isVisible()) {

            fragmentTransaction.add(R.id.fragment_home, addNewComplaintFragment, "0");
            fragmentTransaction.commit();

        } else {

            fragmentTransaction.show(addNewComplaintFragment);
...
//            }
    ...
    public void loadAddComplaintsFragment() {
        ...
        if (!addNewComplaintFragment.isAdded() && !addNewComplaintFragment.isVisible()) {
            ...
            if (complainHomeFragment.isAdded()) {
                fragmentTransaction.hide(complainHomeFragment);
            }
...
//            complainHomeFragment.refresh();
    ...
    public void loadComplaintsFragment() {
        ...
        if (!complainHomeFragment.isAdded() && !complainHomeFragment.isVisible()) {
            ...
            fragmentTransaction.add(R.id.fragment_home, complainHomeFragment, "1");

            if (addNewComplaintFragment.isAdded()) {
                fragmentTransaction.hide(addNewComplaintFragment);
            }
